...
def transcribe(
    model: "Whisper",
    audio: Union[str, np.ndarray, torch.Tensor], ffmpeg_path,
    *,
    ...
    **decode_options,
    ...
    mel = log_mel_spectrogram(audio, ffmpeg_path)
    ...
    with tqdm.tqdm(total=num_frames, unit='frames', disable=verbose is not False) as pbar:
        while seek < num_frames:
            ...
            # Lucid Whisper https://github.com/openai/whisper/discussions/679
